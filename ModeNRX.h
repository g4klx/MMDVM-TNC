...
const uint16_t MODEN_MAX_LENGTH_SAMPLES = (1023U + MODEN_HEADER_LENGTH_BYTES + MODEN_HEADER_PARITY_BYTES + 5U * MODEN_PAYLOAD_PARITY_BYTES + MODEN_CRC_LENGTH_BYTES) * MODEN_SYMBOLS_PER_BYTE * MODEN_RADIO_SYMBOL_LENGTH;
