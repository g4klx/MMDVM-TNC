...
const uint8_t  MODE2_SYNC_BYTES[]        = {0x55U, 0xFDU, 0xDDU, 0x57U, 0xDFU, 0x7FU};
...
const uint64_t MODE2_SYNC_BITS      = 0x000055FDDD57DF7FU;
const uint64_t MODE2_SYNC_BITS_MASK = 0x0000FFFFFFFFFFFFU;

// 5     5      F     D      D     D      5     7      D     F      7     F
// 01 01 01 01  11 11 11 01  11 01 11 01  01 01 01 11  11 01 11 11  01 11 11 11
// +3 +3 +3 +3  -3 -3 -3 +3  -3 +3 -3 +3  +3 +3 +3 -3  -3 +3 -3 -3  +3 -3 -3 -3

const int8_t MODE2_SYNC_SYMBOLS_VALUES[] = {+3, +3, +3, +3, -3, -3, -3, +3, -3, +3, -3, +3, +3, +3, +3, -3, -3, +3, -3, -3, +3, -3, -3, -3};

const uint32_t MODE2_SYNC_SYMBOLS      = 0x00F15E48U;
const uint32_t MODE2_SYNC_SYMBOLS_MASK = 0x00FFFFFFU;
